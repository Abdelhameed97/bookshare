          ...
          <div key={i} className="col-md-6 col-lg-4 mb-4">
            <div className="card h-100 shadow-sm">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">✍️ المؤلف: {book.author}</li>
                <li className="list-group-item">🏷️ التصنيف: {book.category}</li>
                <li className="list-group-item">💰 السعر: {book.price} ج.م</li>
                {book.rental_price && (
