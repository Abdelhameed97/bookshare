...
import { BookOpen, MapPin, Star, Search, Building2, Eye } from "lucide-react"
    ...
    const fetchLibraries = async () => {
        try {
            ...
            const librariesData = owners.map(owner => {
                const ownerBooks = allBooks.filter(
                    book => book.user_id === owner.id
                )
                ...
                return {
                    ...
                    image: ownerBooks[0]?.images?.[0]
                        ? ownerBooks[0].images[0].startsWith("http")
                            ...
                            : `http://localhost:8001/storage/${ownerBooks[0].images[0]}`
                        : "/placeholder.svg",
                }
            })
            ...
            <div className="libraries-page">
                <div className="libraries-header">
                    <div className="header-content">
                        ...
                        <p>
                            Explore amazing book collections from library owners
                            around the world
                        </p>
                    </div>
                </div>
