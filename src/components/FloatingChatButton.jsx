...
const FloatingChatButton = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const botMessage = { 
        id: Date.now() + 1,
        text: data.message || "عذرًا، لم أفهم سؤالك. يمكنك طرح أسئلة عن الكتب أو التصنيفات.",
        isUser: false,
              ...
              >
                ...
                {msg.books && msg.books.length > 0 && (
                  <div className="book-suggestions">
                    ...
                    <p className="follow-up">هل يمكنني مساعدتك في شيء آخر؟</p>
                  </div>
                )}
              </div>
            ))}
